          ...
          <div className='container-fluid loginContainer'>
              <div className='row'>
                  ...
                  <div className='col-md-8 loginFields mb-0'>
                      ...
                      <span className='loginBorder'></span>
                      ...
                      <form>
                        <div className="row">  
                            ...
                            <div className="col-md-6 mb-4">  
                                ...
                                <input type="text" id="form3Example1n" placeholder='Email' className="form-control form-control-lg" />  
                        ...
                        <div className='row'> 
                            <div className="col-md-6 mb-4">
                            <label className="form-label" for="form3Example1n1">Phone Number </label>
                                <div className='row'>  
                                    <div className='col-md-3 form-ele1'>
                                        <select className="form-control bg-white border-md border-left-0 pl-3" style={{ width:50}}> 
                                    ...
                                    <div className='col-md-9 form-ele1'>
                                        <input id="phoneNumber" type="tel" name="phone" placeholder="Phone Number" style={{ width: 147}} className="form-control bg-white border-md border-left-0 pl-3"/>                              
                                    </div>
                                </div>
                            </div>                         
                            <div className="col-md-6 mb-4">  
                                <div className="form-outline"> 
                                    <label className="form-label" for="form3Example1n1">Date of Birth </label>   
                                <input type="date" placeholder='Date of Birth' id="form3Example1n1" class="form-control form-control-lg" />  
                    ...
                    <div className="row">  
                        <div className="col-md-6 mb-4">  
                            <div className="form-outline">
                                <label className="form-label" for="form3Example1m1">Gender </label>    
                                <select className="form-control bg-white border-md border-left-0 pl-3"> 
                        ...
                        <div className="col-md-6 mb-4">  
                            <div className="form-outline"> 
                                <label className="form-label" for="form3Example1n1"> ID Type </label>   
                                <input type="text" id="form3Example1n1" placeholder='ID Type' className="form-control form-control-lg" />  
                    ...
                    <div className="row">  
                        <div className="col-md-6 mb-4">  
                            <div className="form-outline">
                            <label className="form-label" for="form3Example1m1">Username </label>    
                                <input type="text" id="form3Example1m1" placeholder="Username" className="form-control form-control-lg" />  
                        ...
                        <div className="col-md-6 mb-4">  
                            <div className="form-outline"> 
                                ...
                                <input type="password" id="form3Example1n1" placeholder="Password" className="form-control form-control-lg" />  
                          ...
                          {/* <div className='form-group'>
                              ...
                              <input className='form-control' placeholder='Minimum 6 characters (Numbers/Letters/Special characters)' type="text" id="username" name="username" />
                          </div>
                          <div className='form-group mb-1'>
                              <label for="Password">Password:</label>
                              <input className='form-control' placeholder='Min 8 characters, upper & lower case, special character & a number)' type="password " id="password" name="password" />
                              <div className="form-group-append">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                          ...
                          <button className='btn signInBtn mb-4'>Register</button>
                      ...
                      <div className='SocialLogin mt-5'>
                              ...
                              <a href='#' className='mr-5'>
                                  <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_1349_3985)">
