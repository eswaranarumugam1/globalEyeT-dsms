...
import { AddSubLicenceType3, LicenseTypeget } from "../../../../services/home/LicensePage"
...
const create = () => {
  ...
  const history = useHistory()
    ...
    const [sublisencetype2list, setSubLicenseType2List] = useState([])
    ...
    const getLicenceType = async () => {
      ...
      const getSubLicenseType2 = async (id) => {
        try {
          const response = await SubLicenseType2(id)
          if (response) {
            if (response.data) {
    ...
    const addSubLicenseType3 = async () => {
      ...
      formData.append('description', description)
        ...
        //     console.log(request)
            try {
                const response = await AddSubLicenceType3(formData)
                if (response) {
                if (response.data) {
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle tag='h4'>Create Sub License Types level 3</CardTitle>
            </CardHeader>
            <CardBody>
                <AvForm>
                    <Row>
                        ...
                        <Col sm='6'>
                            <AvGroup>
                                ...
                                {
                                    sublisencetype2list ? sublisencetype2list.map((ele) => (
                                    <option value={ele.id}>{ele.name}</option>
                                    )) : null
                                }
                                </AvField>
                        ...
                        <Col sm='4'>
                            <Button color='primary' type='submit' onClick={addSubLicenseType3} >
                                Submit
                            </Button>
                        </Col>
                        <Col sm='4'>
