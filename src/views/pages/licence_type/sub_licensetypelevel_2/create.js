...
import { AddSubLicenceType2, LicenseTypeget } from "../../../../services/home/LicensePage"
import {  SubLicenseType, SubLicenseType1, SubLicenseType2, SubLicenseType3 } from "../../../../services/home/admin"
...
const create = () => {
  ...
  const school_id = parseInt(localStorage.getItem("schoolIdToken"))
    ...
    const addSubLicenseType2 = async () => {
      ...
      formData.append('description', description)
        ...
        // const request = {
        //     name, image, license_type_id, sublicense_level_1_id, parent_id
        //     }
            // console.log(request)
            
            try {
                const response = await AddSubLicenceType2(formData)
                if (response) {
                if (response.data) {
            ...
            <CardBody>
                <AvForm>
                    <Row>
                        ...
                        <Col sm='4'>
                            <Button color='primary' type='submit' onClick={addSubLicenseType2} >
                                Submit
                            </Button>
                        </Col>
                        <Col sm='4'>
