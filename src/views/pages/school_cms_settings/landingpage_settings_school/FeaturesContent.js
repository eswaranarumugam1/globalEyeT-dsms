...
const FeaturesContent = () => {
  ...
  const getFeatures = async () => { 
      const enresponse = await FeaturesEnContent(school_id)
      if (enresponse) {
       ...
       const arresponse = await FeaturesArContent(school_id)
      if (arresponse) {
