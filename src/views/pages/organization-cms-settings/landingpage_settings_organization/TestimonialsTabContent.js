...
import { TestimonialsEnContent, TestimonialsArContent, AddTestimonial } from "../../../../services/home/SchoolLandingPage"
...
const TestimonialsTabContent = () => {
  ...
  const getTestimonials = async () => { 
      const enresponse = await TestimonialsEnContent(school_id)
      if (enresponse) {
      ...
      const arresponse = await TestimonialsArContent(school_id)
      if (arresponse) {
  ...
  const testimonialen = async () => {
    ...
    formData.append('testimonial_description', entestimonia_description)
