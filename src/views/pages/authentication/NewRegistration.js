        ...
        <div className='container-fluid loginContainer'>
            <div className='row'>
                ...
                <div className='col-md-8 loginFields mb-0'>
                    ...
                    <form>
                        <div className='row SocialLogin mt-5'>
                        <div className='form-group'>

                            <label for="Full Name">Full Name</label>
                            <input className='form-control' placeholder='enter full name' type="text" id="username" name="username" />
                        </div>
                        <div className='form-group'>
                        ...
                        <div className='form-group'>
                            ...
                            <label for="User Name">ID type:</label>
                            <input className='form-control' placeholder='Minimum 6 characters (Numbers/Letters/Special characters)' type="text" id="username" name="username" />
                        </div>
                        </div>
                        <div className='row'>
                        ...
                        <div className='form-group'>
                            ...
                            <label for="User Name">ID no:</label>
                            <input className='form-control' placeholder='Minimum 6 characters (Numbers/Letters/Special characters)' type="text" id="username" name="username" />
                        </div>
                        </div>
                        <div className='form-group mb-1'>
                            <label for="Password">Password:</label>
                            <input className='form-control' placeholder='confirm password' type="password " id="password" name="password" />
