...
import '../../../styles/Usernewpassword.css'
                ...
                <div className='container'>
                    <Card className='card' >
                        ...
                        <div style={{ margin: 0, padding: 0 }} class="row" >
                            ...
                            <center>
                                <h2 style={{ color: 'black', marginTop: '20px' }}>Create New Password </h2>
                                    ...
                                    <div className='emailDiv' >
                                        ...
                                        <Col>
                                            ...
                                            className = 'input-field'
                                                type='password'
                                                InputPasswordToggle
                                                placeholder='Minimum 8 characters with upper & lower case and a symbol or a number' fontSize='12px'
                                            />
                                        </Col>
                                        </div>
                                    {/* </Row> */}
                                ...
                                <Button className='login-button' color="danger">Login</Button>
