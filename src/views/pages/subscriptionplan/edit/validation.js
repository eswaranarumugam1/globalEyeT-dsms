...
import { Card, CardHeader, CardTitle, CardBody, Label, Button, Row, Col, CustomInput, CardText } from 'reactstrap'
import {
  AvForm,
  AvGroup,
  AvField,
...
import { AllComponent_with_session } from '../../../../services/home/Componentsapi'
          ...
          <Row>
            ...
            <Col sm='6'>
              <AvGroup>
                ...
                }} required placeholder="Name" value={totalhours} />
              ...
              <Row>
                <Col sm='8'>
                  <AvGroup>
                    ...
                    <AvInput name='t_price' id='t_price' onChange={(e) => {
            ...
            {/* <Col sm='6'>
              <Label for='componenet_list'>Componenet List</Label>
              <Row>
                {
                  componentlist ? componentlist.map((ele, index) => (
                    <Col sm='12'>
                      <CustomInput inline type='checkbox' id={ele.id} label={ele.name} OnCheckedChanged={(e) => {
