          ...
          <div className='container-fluid loginContainer'>
              <div className='row'>
                  ...
                  <div className='col-md-8 loginFields mb-0'>
                      <h4>Verification</h4><br/>
                      <h6>Please Enter the code received in your Mobile/Email</h6>
                      ...
                      <form>
                          ...
                          <div className="col-md-1 mb-4">  
                                <div className="form-outline"> 
                                     <input  type="number" className="form-control form-control-lg" onkeyup='tabChange(1)' maxlength={1}  />  
                                
                                </div>  
                            </div>  
                            <div className="col-md-1 mb-4">  
                                <div className="form-outline">  
                                <input type="number" className="form-control form-control-lg"  onkeyup='tabChange(2)' maxlength={1}  />  
                                    
                                </div>  
                            </div>  
                            <div className="col-md-1 mb-4">  
                                <div className="form-outline"> 
                                     <input  type="number" className="form-control form-control-lg" onkeyup='tabChange(3)' maxlength={1}  />  
                                
                                </div>  
                            </div>  
                            <div className="col-md-1 mb-4">  
                                <div className="form-outline">  
                                <input className="form-control form-control-lg" type="number"  onkeyup='tabChange(4)' maxlength={1} />  
                                    
                                </div>  
                            </div>  
                              {/* <label for="User Name">Enter your email address:</label>
                          ...
                          <button className='btn signInBtn mb-4'>Send OTP</button>
